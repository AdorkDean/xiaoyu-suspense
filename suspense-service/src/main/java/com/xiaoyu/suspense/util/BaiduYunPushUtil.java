...
import com.xiaoyu.suspense.entity.push.AndroidCustomField;
import com.xiaoyu.suspense.entity.push.AndroidPushContent;
import com.xiaoyu.suspense.entity.push.IosPushAps;
import com.xiaoyu.suspense.entity.push.IosPushContent;
import com.xiaoyu.suspense.enums.MsgType;
import com.xiaoyu.suspense.spring.adapter.PropertyHolder;
...
public class BaiduYunPushUtil {
	...
	static {
		psTypeMap.put(MsgType.SUSPENSE_PUSH_INFO, 1);
		psTypeMap.put(MsgType.OTHER, 2);
	}
