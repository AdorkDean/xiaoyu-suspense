...
import com.xiaoyu.suspense.service.BusiQuestionService;
import com.xiaoyu.suspense.util.ResultMessageBuilder;
import com.xiaoyu.suspense.vo.BusiQuestionVO;
...
//<=================定制内容开始==============
	...
	public void getAllSafeQuestions(HttpServletResponse response) {
		...
		if (CollectionUtils.isEmpty(list)) {
			writeAjaxJSONResponse(ResultMessageBuilder.build(false, "没有密保问题!", voList), response);
		    return;
		}
		BusiQuestionVO vo;
