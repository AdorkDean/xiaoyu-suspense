...
public class BusiCommentVO implements BaseVO {
	...
	*/
	...
	public void setBscotStory(String bscotStory) {
		this.bscotStory = bscotStory;
	}

	public String getBscotStory( ) {
		return bscotStory;
	}
	...
	public void convertPOToVO(Object poObj) {
		...
		this.bscotStory = po.getBscotStory();
