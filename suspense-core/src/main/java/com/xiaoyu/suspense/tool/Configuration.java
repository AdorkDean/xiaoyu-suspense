...
public class Configuration {
	...
	public static Configuration configure() {
		try {
			InputStream in = new FileInputStream(System.getProperty("user.dir")+"/src/main/java/com/xiaoyu/suspense/tool/tools.Properties");
			//Configuration.class.getResourceAsStream("/com/xiaoyu/suspense/tool/tools.Properties");
